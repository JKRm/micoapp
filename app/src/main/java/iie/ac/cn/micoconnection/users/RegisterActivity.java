...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVerificationView = (TextView)findViewById(R.id.verification_code);
        ...
        mEmailView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                boolean isValid = isEmailValid(mEmailView.getText().toString());
                if(!hasFocus && isValid){
                    if(isValid){
        ...
        mSendCodeButton = (Button)findViewById(R.id.send_vcode);
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(email) || TextUtils.isEmpty(verification_code)) {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(email, password, verification_code);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String email, String password, String verification_code) {
            mEmail = email;
            mPassword = password;
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            Map<String, String> keyParams = new HashMap<>();
            keyParams.put("username", mEmail);
            keyParams.put("password", mPassword);
            keyParams.put("verification_code", mVerificationCode);
            int status_code = UserHttpRequest.sendHttpRequest(keyParams, HttpRequest.HttpMethod.POST,
                    "http://api.easylink.io/v2/users", RegisterActivity.this);
            if(status_code == 1){
                return true;
            }
            return false;
